...
#' @param min_size numeric, minimum size of checklists (in km2) to be included in the analysis.
#' @param max_size numeric, maximum size of checklists (in km2) to be included in the analysis.
...
giftRegions <- function(species,min_size=1000,max_size=100000000000){
  ...
  if(length(jdata)==0){warning(paste0("GIFT does not have checklists for ",species,"."))
  }else{
